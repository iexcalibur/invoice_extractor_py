...
def diagnose():
    ...
    try:
        ...
        print(f"WARNING: Tesseract not available, skipping OCR check")
    except Exception as e:
    ...
    print("-"*80)
    if ocr_text is None:
        print("WARNING: Skipping regex check - OCR text not available")
    else:
        try:
            import sys
            project_root = Path(__file__).parent.parent
            ...
            print(f"WARNING: regex_extractor not available")
        except Exception as e:
    ...
    if ocr_text is None:
        print("WARNING: Skipping common issues check - OCR text not available")
    else:
